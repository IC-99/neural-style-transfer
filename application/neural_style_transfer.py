...
def neural_network(content_image, style_image):
    ...
    keras.utils.save_img('./static/' + output_file_name, img)        
...
def transfer(content_image_file: datastructures.file_storage.FileStorage, style_image_file: datastructures.file_storage.FileStorage):
    ...
    neural_network(content_image, style_image)
